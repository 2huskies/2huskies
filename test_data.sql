...
INSERT INTO public.university(
	name, active, url, short_name, city, rate)
	VALUES ('Московский государственный университет имени М.В. Ломоносова', true, 'localhost:3082', 'МГУ имени М.В. Ломоносова', 'Москва', 647),
	('Санкт-Петербургский государственный университет', true, 'localhost:3083', 'СПбГУ', 'СПБ', 616),
	('Московский физико-технический институт', true, 'localhost:3084', 'МФТИ', 'Москва', 612),
	('Национальный исследовательский университет "Высшая школа экономики"', true, 'localhost:3085', 'НИУ ВШЭ', 'Москва', 606),
	('Университет "Лютик"', false, 'localhost:3085', 'У Лютик', 'Москва', NULL);
